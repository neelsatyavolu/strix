...
- **Updated**: 2026-07-30T03:16:12.000Z
- **Sessions**: 7
...
Usage MCQ now re-samples 1 correct + 3 wrongs from pools each appearance (lib/vocab/usageOptions.ts); retries get different sentences; API accepts any correct-pool passage.
