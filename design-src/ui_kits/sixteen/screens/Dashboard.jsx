...
function Dashboard({ go }) {
  const { Card, Button, Badge, ScoreBadge, AccuracyRing, StatCard } = window.SixteenDesignSystem_375889;
    ...
    <div style={{ padding: '28px 36px', maxWidth: 980 }}>
      ...
      <Card padding="lg" style={{ marginBottom: 20 }}>
        <div style={{ display:'flex', gap: 24, alignItems:'center', flexWrap:'wrap' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap: 8 }}>
            <Button variant="primary" size="lg" onClick={() => go('practice-setup')} icon={<i data-lucide="play" style={{width:14, height:14}}/>}>
              New session
            </Button>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(280px, 1fr))', gap: 16, marginBottom: 20 }}>
        <Card padding="lg">
          ...
          <Button variant="outline" fullWidth iconRight={<i data-lucide="chevron-right" style={{width:14, height:14}}/>} onClick={() => go('practice-setup', { domain: 'rw' })}>
        ...
        <Card padding="lg">
          ...
          <Button variant="outline" fullWidth iconRight={<i data-lucide="chevron-right" style={{width:14, height:14}}/>} onClick={() => go('practice-setup', { domain: 'math' })}>
            Drill Math
          </Button>
        </Card>
      </div>
