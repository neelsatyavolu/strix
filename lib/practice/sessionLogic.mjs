...
/** @deprecated All module items are scored; always returns []. */
...
/**
 * Pick extra items so a module reaches Bluebook length (still scored).
...
/** Module-2 routing uses every item in the module (all scored). */
export function moduleRoutingStats(questions, responses, pretestIds = [], isCorrect) {
  void pretestIds;
  return {
    correct: questions.filter((q) => isCorrect(q, responses[q.id])).length,
