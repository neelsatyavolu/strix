...
export const PREPAINT = `(function(){var d=document.documentElement;d.setAttribute('data-page','landing');try{var t=localStorage.getItem('${THEME_KEY}');var dark=t==='dark'||(t!=='light'&&window.matchMedia&&window.matchMedia('(prefers-color-scheme: dark)').matches);if(dark)d.setAttribute('data-theme','dark');}catch(e){}})()`;
